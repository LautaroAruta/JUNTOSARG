  ...
  return (
    <div style={{ position: "relative", width: size, height: size, flexShrink: 0 }}>
      ...
      {label && <div style={{
        ...
        fontSize: size * .18, fontWeight: 800, color, fontFamily: "'Syne',sans-serif"
      }}>{label}</div>}
    </div>
  );
}
...
function MiniBar({ value, max, color = T.blue, height = 6 }) {
  ...
  return (
    <div style={{ height, borderRadius: height, background: T.slateXL, overflow: "hidden", flex: 1 }}>
      <div style={{
        height: "100%", width: `${pct * 100}%`, background: color, borderRadius: height,
...
const Card = ({ children, style: s, onClick, className = "" }) => (
  <div className={className} onClick={onClick}
    style={{
      background: T.white, borderRadius: 20, padding: 20, boxShadow: "0 2px 18px rgba(15,23,42,.07)",
...
const Btn = ({ children, onClick, v = "primary", size = "md", full, style: s, disabled, loading }) => {
  ...
  return (
    <button onClick={disabled || loading ? undefined : onClick} disabled={disabled || loading}
      style={{
        ...vars[v], padding: pad[size], fontSize: fs[size], fontWeight: 700, borderRadius: 12,
...
const Badge = ({ children, c = T.blue, style: s }) => (
  <span style={{
    background: c + "1C", color: c, fontWeight: 700, fontSize: 11, padding: "3px 9px",
    borderRadius: 20, display: "inline-flex", alignItems: "center", gap: 3, ...s
  }}>{children}</span>
);
...
const Input = ({ label, value, onChange, type = "text", placeholder, hint, error, prefix, autoFocus, suffix }) => {
  ...
  return (
    <div>
      ...
      <div style={{
        display: "flex", alignItems: "center", border: `1.5px solid ${error ? T.red : focus ? T.blue : T.slateXL}`,
        ...
        <input value={value} onChange={e => onChange(e.target.value)} type={type} placeholder={placeholder}
          ...
          style={{
            flex: 1, padding: "12px 14px", border: "none", outline: "none", fontSize: 14,
...
const Toast = ({ msg, type = "success", onClose }) => {
  ...
  const C = {
    success: { bg: T.greenPale, bd: T.green, tx: T.green },
...
const Sheet = ({ children, onClose, title, height = "auto" }) => (
  <div className="fi" onClick={onClose} style={{
    ...
    <div className="slide" onClick={e => e.stopPropagation()}
      style={{
        background: T.white, borderRadius: "24px 24px 0 0", width: "100%", maxWidth: 480,
      ...
      {title && (
        <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", padding: "16px 20px 14px" }}>
          ...
          <button onClick={onClose} style={{
            background: T.bg, border: "none", width: 32, height: 32,
            borderRadius: 10, cursor: "pointer", fontSize: 15, color: T.slate
          }}>✕</button>
        </div>
      )}
...
function Onboarding({ onDone }) {
  ...
  return (
    <div style={{
      minHeight: "100vh", background: `linear-gradient(145deg,${s.color[0]},${s.color[1]})`,
      display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "space-between",
      padding: "60px 28px 48px", transition: "background 0.5s ease"
    }}>
      <FONTS />
      <Logo scale={0.9} white />
      <div className="fu" key={step} style={{
        ...
        <div>
          <div style={{
            ...
            marginBottom: 16, lineHeight: 1.2, whiteSpace: "pre-line"
          }}>{s.title}</div>
                  ...
                  <div style={{ display: "flex", gap: 8 }}>
                    {[{ v: "client", l: "🛒 Cliente" }, { v: "provider", l: "🏪 Proveedor" }, { v: "admin", l: "⚙️ Admin" }].map(r => (
                      <button key={r.v} onClick={() => setRole(r.v)}
                        style={{
                          flex: 1, padding: "9px 4px", border: `2px solid ${role === r.v ? T.blue : T.slateXL}`,
...
function ProductCard({ p, joined, fav, onClick, onFav }) {
  ...
  return (
    <div onClick={onClick} style={{
      borderRadius: 20, overflow: "hidden", background: T.white,
      ...
      {/* Image area */}
      <div style={{
        height: 108, background: `linear-gradient(135deg,${grad[0]},${grad[1]})`,
        ...
        {p.image_url ? (
          ...
          <div style={{ fontSize: 48, filter: "drop-shadow(0 4px 8px rgba(0,0,0,.3))" }}>{p.emoji}</div>
        )}
        {/* Discount badge */}
        <div style={{
          position: "absolute", top: 8, left: 8, background: T.green, color: "#FFF",
          fontWeight: 800, fontSize: 12, padding: "3px 10px", borderRadius: 8
        }}>-{disc}%</div>
        {/* Tag */}
        {p.tag && <div className="pulse" style={{
          position: "absolute", top: 8, right: 36, background: "rgba(0,0,0,.35)",
        ...
        <button onClick={e => { e.stopPropagation(); setFavAnim(true); setTimeout(() => setFavAnim(false), 400); onFav && onFav(p.id); }}
          ...
          style={{
            position: "absolute", top: 6, right: 6, background: "rgba(255,255,255,.2)",
        ...
        {/* joined */}
        {joined && <div style={{
          position: "absolute", bottom: 6, right: 6, background: "rgba(22,197,94,.9)",
          color: "#FFF", fontWeight: 700, fontSize: 10, padding: "2px 8px", borderRadius: 6
        }}>✓ Unido</div>}
      </div>
      {/* Content */}
  ...
  return (
    <div style={{ paddingBottom: 104 }}>
      ...
      <div style={{ background: T.navy, padding: "16px 18px 28px", borderRadius: "0 0 28px 28px", position: "relative", overflow: "hidden" }}>
        ...
        {/* XP bar */}
        <div style={{
          background: "rgba(255,255,255,.08)", borderRadius: 12, padding: "8px 12px",
        ...
        <div style={{ position: "relative" }}>
          ...
          <input value={q} onChange={e => setQ(e.target.value)} placeholder="Buscar yerba, aceite, pollo..."
            style={{
              width: "100%", padding: "11px 14px 11px 40px", border: "none", borderRadius: 14,
              fontSize: 13, background: "rgba(255,255,255,.1)", color: "#FFF", outline: "none"
            }} />
          {q && <button onClick={() => setQ("")} style={{
            position: "absolute", right: 12, top: "50%", transform: "translateY(-50%)",
            background: "none", border: "none", color: "rgba(255,255,255,.5)", cursor: "pointer", fontSize: 16
          }}>✕</button>}
        </div>
      </div>
      ...
      <div style={{ padding: "14px 16px 0" }}>
        ...
        {banner && (
          <div className="fu" style={{
            background: "linear-gradient(135deg,#1651E0,#0891B2)",
          ...
          <div style={{ marginBottom: 20 }}>
            ...
            <div style={{ display: "flex", gap: 10, overflowX: "auto", paddingBottom: 6, marginLeft: -2, paddingLeft: 2 }}>
              {hot.map(p => {
                ...
                const grad = T.cats[p.cat] || [T.navy, T.blue];
                return (
                  <div key={p.id} onClick={() => onProduct(p)} style={{
                    minWidth: 155,
                    ...
                    {p.image_url ? (
                      <div style={{ width: 44, height: 44, borderRadius: 10, overflow: "hidden", marginBottom: 6 }}>
                        <img src={p.image_url} style={{ width: "100%", height: "100%", objectFit: "cover" }} />
                      </div>
                    ) : (
        ...
        <div style={{ display: "flex", gap: 8, overflowX: "auto", marginBottom: 16, paddingBottom: 4 }}>
          {CATS.map(c => (
            <button key={c} onClick={() => setCat(c)}
              style={{
                padding: "7px 15px", borderRadius: 20, border: "none", cursor: "pointer", fontWeight: 600, fontSize: 12,
        ...
        {!q && (
          <div style={{
            marginTop: 22, background: T.navy, borderRadius: 18, padding: "16px 18px",
        ...
        {!q && (
          <div style={{
            marginTop: 12, background: "linear-gradient(135deg,#166534,#22C55E)",
  ...
  if (view === "success") return (
    <div style={{ padding: 24, paddingBottom: 100 }}>
      <button onClick={onBack} style={{
        background: T.bg, border: "none", borderRadius: 12, padding: "8px 14px",
        cursor: "pointer", fontWeight: 600, fontSize: 13, color: T.slate, marginBottom: 20
      }}>← Volver</button>
      <div className="fu" style={{ textAlign: "center" }}>
        ...
        <div style={{
          display: "inline-block", padding: 20, background: "#FFF", borderRadius: 24,
        ...
        <div className="ca" style={{
          background: "linear-gradient(135deg,#1651E0,#0891B2)", borderRadius: 18,
  ...
  if (view === "pay") return (
    <div style={{ padding: "20px 18px 100px" }}>
      <button onClick={() => setView("detail")} style={{
        ...
        padding: "8px 14px", cursor: "pointer", fontWeight: 600, fontSize: 13, color: T.slate, marginBottom: 18
      }}>← Volver</button>
      ...
      <Card style={{ marginBottom: 14, padding: 16 }}>
        ...
        <div style={{ display: "flex", gap: 8, marginBottom: 10 }}>
          <input value={coupon} onChange={e => setCoupon(e.target.value)} placeholder="Código de cupón (JUNTO10)"
            style={{
              flex: 1, padding: "10px 12px", border: `1.5px solid ${couponApplied ? T.green : T.slateXL}`,
      ...
      <div style={{
        background: T.blueLight, borderRadius: 14, padding: "12px 14px", marginBottom: 18,
  ...
  return (
    <div style={{ paddingBottom: 100 }}>
      ...
      <div style={{
        ...
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", marginBottom: 14 }}>
          <button onClick={onBack} style={{
            ...
            borderRadius: 12, width: 38, height: 38, cursor: "pointer", fontSize: 18, color: "#FFF"
          }}>←</button>
          <div style={{ display: "flex", gap: 8 }}>
            <button onClick={() => { onFav && onFav(p.id); toastFn(fav ? "💔 Eliminado de favoritos" : "❤️ Guardado en favoritos", "info"); }}
              style={{
                background: "rgba(255,255,255,.15)", border: "none", width: 38, height: 38,
        ...
        <div style={{ textAlign: "center" }}>
          ...
          <div style={{
            ...
            <div style={{ display: "flex", gap: -4 }}>
              {["🔵", "🟢", "🟡"].map((c, i) => (
                <div key={i} style={{
                  width: 18, height: 18, borderRadius: "50%", background: `hsl(${200 + i * 30},70%,60%)`,
      ...
      <div style={{ padding: "28px 18px 0" }}>
        ...
        {/* Store link */}
        <div style={{
          display: "flex", alignItems: "center", gap: 10, background: T.bg, borderRadius: 12,
        ...
        <Card style={{ marginBottom: 14 }}>
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 8, marginTop: 10 }}>
            <div style={{ display: "flex" }}>
              ...
              {p.cur > 5 && <div style={{
                width: 28, height: 28, borderRadius: "50%", background: T.slateXL,
                marginLeft: -8, border: "2px solid #FFF", display: "flex", alignItems: "center",
                justifyContent: "center", fontSize: 10, color: T.slate, fontWeight: 700
              }}>+{p.cur - 5}</div>}
            </div>
        ...
        <div style={{
          display: "flex", background: "#FFF", borderRadius: 14, padding: 4, marginBottom: 14,
          boxShadow: "0 2px 12px rgba(0,0,0,.06)"
        }}>
          {[{ v: "info", l: "ℹ️ Info" }, { v: "reviews", l: `⭐ Reseñas (${reviews.length})` }, { v: "chat", l: `💬 Chat (${chatMsgs.length})` }].map(t => (
            <button key={t.v} onClick={() => setTab(t.v)}
              style={{
                flex: 1, padding: "8px 0", border: "none", cursor: "pointer", fontWeight: 700, fontSize: 11,
              ...
              <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
                ...
                <div style={{ display: "flex", alignItems: "center", gap: 14 }}>
                  <button onClick={() => setQty(q => Math.max(1, q - 1))}
                    style={{
                      width: 34, height: 34, borderRadius: 10, border: `2px solid ${T.slateXL}`,
                      background: "#FFF", cursor: "pointer", fontWeight: 800, fontSize: 20, color: T.slate
                    }}>−</button>
                  ...
                  <button onClick={() => setQty(q => Math.min(p.stock, q + 1))}
                    style={{
                      ...
                      background: T.blue, cursor: "pointer", fontWeight: 800, fontSize: 20, color: "#FFF"
                    }}>+</button>
                </div>
              </div>
              <Div />
            ...
            {reviews.length === 0 ? (
              ...
              <Card key={r.id} style={{ marginBottom: 10, padding: 14 }}>
                <div style={{ display: "flex", gap: 10, alignItems: "center", marginBottom: 8 }}>
                  <div style={{
                    width: 36, height: 36, borderRadius: "50%", background: T.blue,
                    display: "flex", alignItems: "center", justifyContent: "center",
        ...
        {tab === "chat" && (
          <div>
            <div style={{
              background: T.slatePale, borderRadius: 14, padding: 14, marginBottom: 12,
              ...
              {chatMsgs.length === 0 ? (
                ...
                <div key={m.id} style={{
                  display: "flex", flexDirection: m.self ? "row-reverse" : "row",
                  ...
                  <div style={{ maxWidth: "72%" }}>
                    ...
                    <div style={{
                      background: m.self ? T.blue : T.white, color: m.self ? "#FFF" : T.dark,
            ...
            <div style={{ display: "flex", gap: 8 }}>
              <input value={chatMsg} onChange={e => setChatMsg(e.target.value)}
                ...
                style={{
                  flex: 1, padding: "11px 14px", border: `1.5px solid ${T.slateXL}`,
                  borderRadius: 12, fontSize: 13, outline: "none"
                }} />
              <button onClick={sendChat} style={{
                width: 44, height: 44, borderRadius: 12, border: "none",
                background: T.blue, cursor: "pointer", fontSize: 18, color: "#FFF"
              }}>↑</button>
            </div>
          </div>
        )}
      ...
      <div style={{ paddingBottom: 100 }}>
        <div style={{
          ...
          <button onClick={() => setSelected(null)} style={{
            ...
            borderRadius: 12, width: 38, height: 38, cursor: "pointer", fontSize: 18, color: "#FFF", marginBottom: 12
          }}>←</button>
          <div style={{ display: "flex", gap: 14, alignItems: "center" }}>
            <div style={{
              width: 60, height: 60, borderRadius: 18, background: "rgba(255,255,255,.1)",
          ...
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 8 }}>
            ...
            <div style={{ textAlign: "center" }}>
              <div style={{
                ...
                color: d.votes >= 10 ? T.green : T.blue
              }}>{d.votes}</div>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 14, paddingBottom: 20 }}>
            ...
            <div>
              ...
              <select value={form.cat} onChange={e => f("cat", e.target.value)}
                style={{
                  width: "100%", padding: "12px 14px", border: `1.5px solid ${T.slateXL}`, borderRadius: 12,
        ...
        {myProds.length === 0 ? (
          ...
          return (
            <Card key={p.id} style={{ marginBottom: 12, padding: 16 }}>
              ...
              {done && (
                <button style={{
                  width: "100%", marginTop: 12, padding: "10px", background: T.greenPale,
...
function NotificationsView({ notifs, onMarkRead }) {
  return (
    <div style={{ padding: "18px 16px 100px" }}>
      ...
      {notifs.map(n => (
        <div key={n.id} style={{
          background: n.read ? T.white : T.blueLight, borderRadius: 16, padding: "14px 16px",
...
function ProfileView({ user, joined, products, onLogout, toastFn }) {
  ...
  return (
    <div style={{ paddingBottom: 100 }}>
      {/* Hero */}
      <div style={{
        background: `linear-gradient(145deg,${T.navy},${T.blue})`,
      ...
      <div style={{ padding: "16px 16px 0" }}>
        {/* Tabs */}
        <div style={{
          display: "flex", background: T.white, borderRadius: 14, padding: 4, marginBottom: 16,
          boxShadow: "0 2px 12px rgba(0,0,0,.06)"
        }}>
        ...
        {tab === "badges" && (
          <div>
            ...
            {BADGES.map((b, i) => {
              ...
              return (
                <div key={b.id} style={{
                  background: earned ? T.white : T.slatePale, borderRadius: 16, padding: "14px 16px",
            ...
            <Card style={{ background: "linear-gradient(135deg,#166534,#22C55E)", boxShadow: "none", marginBottom: 14 }}>
              ...
              <div style={{
                ...
                <button onClick={() => toastFn("✅ Código copiado", "success")}
                  style={{
                    background: "#FFF", border: "none", borderRadius: 8, padding: "5px 12px",
                    cursor: "pointer", fontWeight: 700, fontSize: 11, color: T.green
                  }}>Copiar</button>
              </div>
...
function ProviderPanel({ products, user, onLogout, toastFn }) {
  ...
  const handlePublish = async () => {
    if (!form.minB || !form.stock || !form.name || !form.pInd || !form.pGroup) {
      toastFn("Completá todos los campos", "error");
      return;
    }
    ...
    try {
      ...
      const { data: product, error: prodError } = await supabase
        .from('products')
        .insert({
          store_id: user.storeId || '11111111-0001-0001-0001-000000000001',
          name: form.name,
          category: form.cat,
          description: form.desc,
          price_individual: parseInt(form.pInd),
          price_group: parseInt(form.pGroup),
          min_buyers: parseInt(form.minB),
          stock: parseInt(form.stock),
          image_url: imageUrl,
          expires_seconds: parseInt(form.time) * 3600,
          emoji: '📦'
        })
        .select()
        .single();
      ...
      const { error: groupError } = await supabase
        ...
        .insert({
          ...
          min_buyers: product.min_buyers,
          status: 'active',
          expires_at: new Date(Date.now() + (parseInt(form.time) * 3600 * 1000)).toISOString()
        });
  ...
  return (
    <div style={{ paddingBottom: 24 }}>
      <FONTS />
      <div style={{
        background: "linear-gradient(135deg,#0B1D3A,#1651E0)",
        ...
        {tab === "publish" && !published && (
          <div>
            ...
            <div style={{ display: "flex", gap: 0, marginBottom: 20 }}>
              {[1, 2].map(s => (
                <div key={s} style={{
                  flex: 1, height: 4, borderRadius: 4, marginRight: s < 2 ? 6 : 0,
            ...
            {step === 1 && (
              <div style={{ display: "flex", flexDirection: "column", gap: 14 }}>
                ...
                <div>
                  ...
                  <select value={form.cat} onChange={e => f("cat", e.target.value)}
                    style={{
                      width: "100%", padding: "12px 14px", border: `1.5px solid ${T.slateXL}`,
                ...
                <div>
                  <div style={{ fontSize: 12, fontWeight: 700, color: T.slate, marginBottom: 8 }}>Imagen del producto</div>
                  <div style={{ display: "flex", gap: 12, alignItems: "center" }}>
                    <label style={{
                      flex: 1, height: 100, border: `2px dashed ${T.slateXL}`, borderRadius: 16,
                      ...
                      {imagePreview ? (
                        ...
                        <>
                          ...
                          <span style={{ fontSize: 10, color: T.slateL, marginTop: 4 }}>Subir imagen</span>
                        </>
                      )}
                      <input type="file" accept="image/*" onChange={handleImageChange} style={{ display: "none" }} />
                    </label>
                    <div style={{ flex: 1.5, fontSize: 11, color: T.slateL }}>
                ...
                {form.pInd && form.pGroup && Number(form.pGroup) < Number(form.pInd) && (
                  <div style={{
                    background: T.greenPale, borderRadius: 10, padding: "10px 14px",
            ...
            {step === 2 && (
              <div style={{ display: "flex", flexDirection: "column", gap: 14 }}>
                ...
                <div style={{ display: "flex", gap: 10 }}>
                  ...
                  <Btn v="green" loading={loading} style={{ flex: 2 }} onClick={handlePublish}>✅ Publicar</Btn>
                </div>
              </div>
            )}
          </div>
      ...
      <div style={{ background: "linear-gradient(135deg,#0B1D3A,#0F172A)", padding: "18px 18px 22px", borderRadius: "0 0 28px 28px" }}>
        ...
        <div style={{ display: "flex", gap: 6, marginTop: 14, overflowX: "auto" }}>
          {[{ v: "stats", l: "📊" }, { v: "providers", l: "🏪" }, { v: "orders", l: "📦" }, { v: "config", l: "⚙️" }].map(t => (
            <button key={t.v} onClick={() => setTab(t.v)}
              style={{
                padding: "7px 16px", borderRadius: 10, border: "none", cursor: "pointer", fontWeight: 600,
      ...
      {!selected && (
        <div style={{
          ...
          {NAV.map(n => {
            ...
            return (
              <button key={n.v} onClick={() => { setNavView(n.v); setSelected(null); }}
                ...
                {active && <div style={{
                  position: "absolute", bottom: -1, width: 20, height: 3,
          ...
          <button onClick={() => setNavView("favs")}
            style={{
              position: "absolute", right: 60, top: -20, width: 38, height: 38,
          ...
          <button onClick={() => setNavView("notifs")}
            style={{
              position: "absolute", right: 12, top: -20, width: 38, height: 38,
